...
const DEMOS = {
  1: { title: 'Suchen – Übung 1',
       text: 'Halte das Tablet gerade vor dir, bevor du die Übung startest. Drehe deinen Körper während der Übung, um den Marienkäfer zu finden. Suche dafür in die Richtung, in die das Blatt zeigt.',
  ...
  2: { title: 'Suchen – Übung 2',
       text: 'Halte das Tablet gerade vor dir, bevor du die Übung startest. Drehe deinen Körper während der Übung, um den Uhu zu finden. Suche dafür in die Richtung, aus der der Ton kommt.',
       scene: '<div class="demo-device anim-tilt-left"><div class="device-screen">' +
                ...
                '<div class="demo-obj anim-slide"><img class="thin-outline-sm" src="assets/Uhu.webp"></div>' +
              '</div>' +
              '<img class="demo-hand demo-hand-left" src="assets/Hand.svg">' +
              '<img class="demo-hand demo-hand-right" src="assets/Hand.svg">' +
              '</div>' },
  3: { title: 'Suchen – Übung 3',
       text: 'Halte das Tablet gerade vor dir, bevor du die Übung startest. Drehe deinen Körper während der Übung, um alle Marienkäfer in der richtigen Reihenfolge zu finden. Suche dafür in die Richtung, in die das Blatt zeigt.',
...
function requestSensorPermission(silent) {
  ...
  OrientationControl.requestPermission().then(granted => {
    if (granted) {
      startSensor();
      setPermStatus('Sensor aktiviert <svg class="lucide" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6 9 17l-5-5"/></svg> — drehe das Gerät', true);
...
function startLevel(n) {
  ...
  if (n === 1) {
    ...
    objects = [{ id:'o1', img:'assets/Uhu.webp', size:92, angle: randSide(), vAngle: randVAngle(), color:'#34d399', found:false, thinOutline:true }];
    setupAudio();
  } else if (n === 3) {
    totalCount = 3;
  ...
  $('zone').innerHTML = (n === 2)
    ? '<img class="zone-img thin-outline" src="assets/Nest.webp" alt="Ziel">'
