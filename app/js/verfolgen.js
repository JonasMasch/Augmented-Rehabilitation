...
const DEMOS = {
  1: { title: 'Verfolgen – Übung 1',
       text: 'Halte das Tablet gerade vor dir, bevor du die Übung startest. Drehe deinen Körper während der Übung, um den Schmetterling zu verfolgen. Folge dafür seinen Bewegungen, um ihn auf der Blume zu halten.',
  ...
  2: { title: 'Verfolgen – Übung 2',
       text: 'Halte das Tablet gerade vor dir, bevor du die Übung startest. Drehe deinen Körper während der Übung, um den Uhu zu verfolgen. Folge dafür seinen Geräuschen, um ihn in seinem Nest zu halten.',
       scene: '<div class="demo-device anim-keep"><div class="device-screen">' +
                ...
                '<div class="demo-obj anim-orbit"><img class="thin-outline-sm" src="assets/Uhu.webp"></div>' +
              '</div>' +
              '<img class="demo-hand demo-hand-left" src="assets/Hand.svg">' +
              '<img class="demo-hand demo-hand-right" src="assets/Hand.svg">' +
              '</div>' },
  3: { title: 'Verfolgen – Übung 3',
       text: 'Halte das Tablet gerade vor dir, bevor du die Übung startest. Drehe deinen Körper während der Übung, um den Schmetterling zu verfolgen. Folge dafür seinen Bewegungen, um ihn auf der Blume zu halten, und finde ihn neu, wenn er kurz verschwindet.',
       scene: '<div class="demo-device anim-keep"><div class="device-screen">' +
                '<div class="demo-target"><img class="thin-outline-sm" src="assets/Blume.webp"></div>' +
...
function startLevel(n) {
  ...
  // Alle Objekte und Ziele sind finale Bilder mit .thin-outline (Dilatation,
  // siehe #thinOutline in common.js). .lite-outline (drop-shadow) war der
  // Vorgaenger fuer bewegte Objekte — es erwischt duenne Fuehler und Federn
  // nicht; der fruehere Ruckel-Verdacht gegen SVG-Filter hat sich mit
  // .thin-outline nicht bestaetigt. Groesse via CSS (92 px wie ueberall).
  if (n === 2) {
    obj.innerHTML = '<img class="thin-outline" src="assets/Uhu.webp" alt="">';
